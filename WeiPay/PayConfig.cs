...
namespace WeiPay
{
    ...
    public   class PayConfig
    {
        ...
        /// </summary>
		public static string SendUrl = "http://www.choice.shu.edu.cn/Cart/weixinSubmit"; 

        /// <summary>
        /// 支付页面，请注意测试阶段设置授权目录，在微信公众平台中“微信支付”---“开发配置”--修改测试目录   
        /// 注意目录的层次，比如我的：http://zousky.com/WXPay/
        /// </summary>
		public static string PayUrl = "http://www.choice.shu.edu.cn/Pay/Weixin"; 
        
        /// <summary>
        ///  支付通知页面，请注意测试阶段设置授权目录，在微信公众平台中“微信支付”---“开发配置”--修改测试目录   
        /// 支付完成后的回调处理页面,替换成notify_url.asp所在路径
        /// </summary>
		public static string NotifyUrl = "http://www.choice.shu.edu.cn/Pay/WeixinCompleted"; 
